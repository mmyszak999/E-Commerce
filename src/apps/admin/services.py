...
def modify_superuser_permission(
    session: Session, user_id: int, set_as_superuser: bool
) -> dict[str, str]:
    ...
    return {
        "message": f"Superuser status has been {'granted' if set_as_superuser else 'revoked'} successfully"
    }
