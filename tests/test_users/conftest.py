...
from src.apps.user.schemas import UserOutputSchema, UserRegisterSchema, AddressOutputSchema
...
DB_STAFF_USER_SCHEMA = UserRegisterSchemaFactory().generate(address=DB_ADDRESS_SCHEMAS[1])
